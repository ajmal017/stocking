<template>
  <h4 class="fst-italic">You are a:</h4>
  <h1
    class="display-2 text-info animate__animated animate__fadeIn animate__slow"
  >
    {{ investor.name }}
  </h1>
  <p class="lead">
  ...
  <div
    class="card text-dark mt-5 animate__animated animate__fadeInUpBig animate__delay-1s"
  >
    <div class="card-body">
      <dl class="row">
        <dt class="col-sm-3">Trait:</dt>
        <dd class="col-sm-9 fst-italic">{{ investor.trait }}</dd>

        <dt class="col-sm-3">Risk appetite:</dt>
        <dd class="col-sm-9 fst-italic">{{ investor.risk }}</dd>

        <dt class="col-sm-3">Target:</dt>
        <dd class="col-sm-9 fst-italic">{{ investor.target }}</dd>

        <dt class="col-sm-3">Time Horizon:</dt>
        <dd class="col-sm-9 fst-italic">{{ investor.timeHorizon }}</dd>
